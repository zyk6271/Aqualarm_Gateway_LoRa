...
void product_info_update(void)
{
    ...
    cJSON_AddStringToObject(root, "p", GW_PRODUCT_PID);
...
void data_handle(unsigned short offset)
{
    ...
    switch(cmd_type) {
        ...
        case UPDATE_START_CMD:                                //升级开始
            ...
            upgrade_package_choose(MCU_PACKAGE_SIZE);
        ...
        case SUBDEV_START_UPGRADE_CMD:                          //子设备启动升级
            ...
            lora_ota_begin(atol(sub_id_buf),firm_length);
            //subdev_upgrade_package_choose(SUB_PACKAGE_SIZE,sub_id_buf,sub_id_len);
